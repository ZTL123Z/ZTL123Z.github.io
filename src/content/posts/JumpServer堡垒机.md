...
updated: 2026-05-06
description: JumpServer 是广受欢迎的开源堡垒机，是符合 4A 规范的专业运维安全审计系统。JumpServer 帮助企业以更安全的方式管控和登录所有类型的资产，实现事前授权、事中监察、事后审计，满足等保合规要求。  
image: "api"   
tags: [堡垒机, JumpServer]      
category: 堡垒机
draft: false       
...
很简单，给个链接https://docs.jumpserver.org/zh/v4/
...
```sh
[talen@localhost opt]$ ls -lh
总用量 1.3G
drwxr-xr-x. 2 root  root  4.0K 4月   9 15:10 code
drwx--x--x. 4 root  root  4.0K 4月  12 17:15 containerd
-rw-rw-r--. 1 talen talen 1.3G 5月   6 18:10 jumpserver-ce-v4.10.16-x86_64.tar.gz
drwxr-xr-x. 2 root  root  4.0K 10月 31 2018 rh
drwxr-xr-x. 3 root  root  4.0K 4月  10 19:09 tmp
```
...
DOMAINS=192.168.44.133:8888

> 这个报错是 JumpServer 非常经典的**安全防护机制**。JumpServer 为了防止主机头攻击（Host Header Attack），会验证你访问的域名/IP 是否在允许的白名单内。
...
![image-20260506191539798](https://cdn.jsdelivr.net/gh/ZTL123Z/picgo-imgHub@main/20260506191540309.png)
